...
9. **Create worktree** — invoke `superpowers:using-git-worktrees` to set up an isolated workspace for implementation
...
digraph brainstorming {
    ...
    "User reviews spec?" -> "Create worktree (using-git-worktrees)" [label="approved"];
...
- Invoke `superpowers:using-git-worktrees` to set up an isolated workspace for implementation
